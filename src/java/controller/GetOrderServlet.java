...
public class GetOrderServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (district.equals("hbt")) {
            district = "Hai Bà Trưng";
        }else if (district.equals("dd")) {
            district = "Đống Đa";
        }
//        Order order = new Order(0, orderDate, customer, employee, 0);
//        OrderDetail orderDetail = new OrderDetail(0, order, product, 0, 0, 0, note, note, note, address);
    } 
